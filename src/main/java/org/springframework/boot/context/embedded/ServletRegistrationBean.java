...
public class ServletRegistrationBean extends RegistrationBean {
	...
	/**
	 * Set the URL mappings for the servlet. If not specified the mapping will
	 * default to '/'. This will replace any previously specified mappings.
	 * 
	 * @param urlMappings
	 *            the mappings to set
	 ...
	 *            the multi-part configuration to set or {@code null}
	 */
